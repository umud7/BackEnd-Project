...
namespace BackEnd_Project.Migrations
{
    ...
    [Migration("20230211135014_addCourseImagetable")]
    partial class addCourseImagetable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd_Project.Models.BlogImage", b =>
                {
                    ...
                    b.Property<int?>("LatestBlogId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("LatestBlogId");
            ...
            modelBuilder.Entity("BackEnd_Project.Models.CourseImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackEnd_Project.Models.TeacherDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackEnd_Project.Models.TeacherSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackEnd_Project.Models.TeacherDetail", b =>
                {
                    b.HasOne("BackEnd_Project.Models.Teacher", "Teacher")
                        ...
                        .HasForeignKey("BackEnd_Project.Models.TeacherDetail", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackEnd_Project.Models.TeacherSkill", "TeacherSkill")
                        .WithMany()
